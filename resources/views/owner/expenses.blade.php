...
@foreach($expenses as $expense)
  <div class="modal fade" id="noteModal{{ $expense->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header"><h5 class="modal-title">Note dépense</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
        <div class="modal-body">{{ $expense->notes ?: 'Aucune note' }}</div>
      </div>
    </div>
  </div>
